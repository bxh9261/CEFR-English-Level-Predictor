...
def save_model(model, name):
    ...
    file_name = f"../../cefr_predictor/models/{name}_cs.joblib"
...
X_train, y_train = load_data("../../icnale_country_sorted_data/train.csv")
X_test, y_test = load_data("../../icnale_country_sorted_data/test.csv")
